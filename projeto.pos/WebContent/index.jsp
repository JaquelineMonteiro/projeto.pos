		...
		<div class="container-fluid">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
			  ...
			  <div class="collapse navbar-collapse" id="navbarText">
			    ...
			    <span class="navbar-text">
			      <a class="nav-link" href="/projeto.pos/Controller?command=ConsultaAluno">Área do Professor</a>
			    </span>
			  </div>
			</nav>
			...
			<div class="card text-center">
			  ...
			  <div class="card-body">
			    ...
			    <a href="/projeto.pos/Controller?command=ConsultaAluno" class="btn btn-primary">Consultar</a>
			  </div>
